...
const { userAuth,verifyAdminIdMatch, verifyPermissions } = require('../middlewares');
...
router.get('/getAdminProblemData', userAuth, verifyAdminIdMatch, verifyPermissions('isAllowedToCreateProblem'), problemController.getMyProblemData);
