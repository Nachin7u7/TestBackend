...
router.post(
  ...
  problemCreationController.createProblem
);
router.get(
  '/getProblemData',
  userAuth,
  problemCreationController.getProblemData
);
router.post(
  '/save',
  userAuth,
  verifyPermissions('isAllowedToCreateProblem'),
  problemCreationController.saveProblem
);
router.post(
  '/saveandpublish',
  userAuth,
  verifyPermissions('isAllowedToCreateProblem'),
  problemCreationController.saveAndPublishProblem
);
